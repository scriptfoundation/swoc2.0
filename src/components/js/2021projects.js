export const currentProjects = [
  ...
  {
    Name: "Coding Easy",
    Repo: "https://github.com/arpit456jain/CodingEasy",
    Owner: "Arpit Jain",
    github: "https://github.com/arpit456jain",
    linkedin: "https://www.linkedin.com/in/",
    Description: `A website for learning coding including different tech stacks/technology at one place, our aim is to provide free material as much as possible so that anyone can learn efficiently and faster.`,
  ...
  {
    Name: "ELASTIC-CFC",
    Repo: "https://github.com/Aryamanz29/Elastic-CFC",
    Owner: "ARYAMAN",
    github: "",
    linkedin: "",
    Description: `A log analyser build on top of elasticsearch, it is used to save developer time in debugging.`,
    TechStack: ["DJANGO", "DJANGO REAT FRAMEWORK", "ELASTICSEARCH", "REACTJS"],
  },
  {
    Name: "FireFlyJS",
  ...
  },
  {
    ...
    TechStack: ["Flutter", "Firebase", "NextJS", "Figma"],
  },
  {
  ...
  },
  {
    ...
    linkedin: "",
    Description: `An all in one project for digital privacy. A beginner's guide to get started with cyberspace.`,
    TechStack: ["Go", "CSS", "NodeJS", "Markdown", "HTML"],
  },
  {
    Name: "STUDENT PORTAL",
...

  {
    ...
    Description: `Moosync is an electron based simple music player with a primary goal to provide a clean and easy interface. Through Moosync you can easily listen songs from your desktop or through Youtube and Spotify.`,
    TechStack: [
      "TYPESCRIPT",
      "NODE.JS",
      "VUE",
  ...
  {
    Name: "HASH/HUB",
    Repo: "https://github.com/vedant-jain03/HashHub",
    Owner: "VEDANT JAIN",
    github: "",
    linkedin: "",
    Description: `Hash/Hub is an initiative to provide students with everything that revolves around engineering degrees, we have so many different free Tools to make their Profile more Attractive and Professional. We have a Fields section where they will find out resources, roadmaps, experiences, programs, competitions, tips, and tricks to not just master their degree.`,
...

  {
    ...
    TechStack: ["REACTJS", "SAAS"],
  },

  {
    Name: "Chathub",
    Repo: "https://github.com/soumikbaithalu/Chathub",
    Owner: "SOUMIK KUMAR BAITHALU",
    github: "https://github.com/soumik2012",
    linkedin: "https://www.linkedin.com/in/soumikbaithalu/",
    Description: `The main goal of the project is to connect with people all around the world. This is a Messenger App, made with react, styled with the help of material UI, and deployed with the help of firebase.`,
    TechStack: ["REACTJS", "JS", "CSS", "HTML"],
  },

  {
    Name: "CodeDigger",
    Repo: "https://github.com/Code-dig-ger",
    Owner: "SHIVAM SINGHAL",
    github: "",
...

  {
    ...
    Description: `It is a carpooling website, with a concept of sustainable development. The idea of the website is that the user can see those within 5 km who are traveling to the same destination and can carpool with them. Contributors can use Google APIs to track the location and turn project into product.`,
    TechStack: ["HTML", "CSS", "JS"],
  },

  {
    Name: "Blood-Buddy",
    Repo: "https://github.com/2024-SANDHYA/Blood-Buddy",
    Owner: "SANDHYA AGARWAL",
    github: "https://github.com/2024-SANDHYA",
    linkedin: "https://www.linkedin.com/in/sandhya-agarwal-content-writer/",
    Description: `Bloody Buddy is a blood donation website designed to make hassle free blood donation experience, during COVID-19. The website works on the concept that once a person registers, he will be able to view his nearest blood banks & can contact them, and also those who need blood will be able to speak with one another through the website.`,
    TechStack: ["HTML", "CSS", "JS"],
  },

  {
    Name: "Eden",
    Repo: "https://github.com/Salonee-Jain/Eden",
    Owner: "SALONI JAIN",
    github: "",
    linkedin: "",
    Description: `Eden is your smart personal assistant, using which you can perform your tasks, making your life easier!
    Here's how:
...

  {
    ...
    Description: `A online coding platform with real time error classication so that we can save run time compliation of the program.`,
    TechStack: ["REACT", "HTML", "CSS", "BOOTSTRAP"],
  },
  {
    Name: "CSwaala",
    Repo: "https://github.com/CSwala",
    Owner: "Rituraj Jain",
    ...
    TechStack: ["MOBILE", "APP DEV", "WEB DEV"],
  },
  {
    Name: "Clone-IT",
  ...
  {
    Name: "VOXUP",
    Repo: "https://github.com/prathimacode-hub/VoxUp",
    Owner: "PRATHIMA KADARI",
    github: "https://github.com/prathimacode-hub",
    linkedin: "",
...

  {
    ...
    github: "https://github.com/prathimacode-hub",
    linkedin: "",
    Description: `TollRoll is a dedicated management system to solve all the hurdles and problems related to toll plaza for smoother functioning of the overall process and getting acquainted with the latest upgrades. With this, the user's journey would be more feasible and friendly without any hiccups in drives or outings.`,
    TechStack: [
      "HTML",
      "CSS",
      "JAVASCRIPT",
  ...
  {
    Name: "FARMARK",
    Repo: "https://github.com/prathimacode-hub/FarmArk",
    Owner: "PRATHIMA KADARI",
    github: "https://github.com/prathimacode-hub",
    linkedin: "",
    Description: `FarmArk is an app designed for facilitation of farmers and addresses them with all the needed farming solutions for their greens to prosper and excel. So the aim behind developing this portal is to provide a platform for farmers to make their lives easier and efficient!`,
    TechStack: [
      "HTML",
      "CSS",
      "JAVASCRIPT",
