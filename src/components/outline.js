                  ...
                  {this.state.transform > 400 && (
                    <div class="nav-logo">
                      <a href="/" class="scrollto">
                        <img src="./img/logo-2-no-label.png" />
                      </a>
                    </div>
                  )}
                </div>
                  ...
                  <ul>
                    {navItems.map((item, index) => {
                      return (
                        ...
                        >
                          <a href={item.url} onClick={this.changeActivePage}>
                            {item.title}
                          </a>
                        </li>
                      );
                ...
                <div className="f-content">
                  <div className="f-contact">
                    <div className="f-nav">
                      <ul>
                        <li>
                          <a href="/" onClick={this.changeActivePage}>
                            Home
                          </a>
                        </li>
                        <li>
                          <a href="/#/#about" onClick={this.changeActivePage}>
                            About Us
                          </a>
                        </li>
                        <li>
                          <a href="/#/team" onClick={this.changeActivePage}>
                            Our Team
                          </a>
                        </li>
                        <li>
                      ...
                      <ul className="f-nav-ul">
                        <li>
                          <a href="/#/project" onClick={this.changeActivePage}>
                            Projects
                          </a>
                        </li>
                        <li>
                        ...
                        <li>
                          <a
                            target="_blank"
                            href="https://devfolio.co/code-of-conduct#:~:text=No%20discrimination,gender%20identity%20and%20expression"
                          >
                            Code of Conduct
                          </a>
                        </li>
                  ...
                  <div className="f-logo">
                    <img
                      src={"/img/46463_Script Foundation_Logo_RD_01.png"}
                      alt="logo"
